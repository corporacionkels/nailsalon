							...
							<div class="well col-xs-10 col-sm-10 col-md-12 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
								...
								<table class="table table-hover">
									...
									<tbody>
										...
										foreach ($rows as $row_appoinment) {
										?>
											<tr>
												<td class="col-md-9"><em><?php echo $row_appoinment['service_name'] ?></em></h4>
												</td>
												<td class="col-md-1" style="text-align: center"> <?php echo $row_appoinment['service_duration'] ?> min </td>
												<td class="col-md-1 text-center"><?php echo $row_appoinment['service_price'] ?></td>
												<td class="col-md-1 text-center">$ <?php echo $row_appoinment['service_price'] ?></td>
											</tr>
										<?php
										}
