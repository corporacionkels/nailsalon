...
//$query = mysqli_query($conexion, "SELECT * FROM service_categories WHERE category_id = '$id_categoria'")
...
<section class="booking_section">
	<div class="container">
		...
		<form method="post" id="appointment_form" action="servicios.php">
				...
				<div class="items_tab">
					<div class="panel panel-default">
						<div class="panel-body"><b style="color:#0033FF" ;><?php echo $category_name;?></b>
							<div class="items_tab">
								<?php
								//$stmt = $con->prepare("SELECT * from services WHERE category_id = '$id_categoria'");
								$stmt = $con->prepare("SELECT * from services WHERE category_id = '11'");
								$stmt->execute();
								$rows = $stmt->fetchAll();
	...
	<div style="overflow:auto;padding: 30px 0px;">
		...
		<a href="index.php" class="next_prev_buttons" role="button" style="background-color: #bbbbbb;" aria-pressed="true">Retorna Categorias</a>
	</div>
