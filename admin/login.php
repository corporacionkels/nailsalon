...
<html lang="en">
	<head>
		...
		<title>Espacio Teodora Admin Login</title>
		<!-- FONTS FILE -->
		...
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_username">Nombre Usuario es requerido!</span>
				</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_password">Contraseña es Requerida!</span>
				</div>
				...
				<span class="forgotPW">Olvido su Contraseña ? <a href="#">Recuperala.</a></span>
			</form>
		</div>
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; Espacio Teodoroa 2022</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
