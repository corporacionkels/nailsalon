...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Horarios Profesionales</h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Horario Profesionales</h6>
                </div>
                <div class="card-body">
                        ...
                        <form action="employees-schedule.php" method="POST">
                            <div class="form-group">
                                <label class="control-label" for="emloyee_schedule_select">
                                    Seleccione Profesional para Configurar el Horario:
                                </label>
                                ...
                                {   
                                    ...
                                    ?>
                                        ...
                                        <script type="text/javascript">
                                            swal("Establecer horario de empleados","¡Ha establecido correctamente el horario de empleados!", "success").then((value) => {}); 
                                        </script>
