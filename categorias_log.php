                        ...
                        <form id="form" name="login-form" method="POST" action="loading_services.php">
                            <div class="radio-group row justify-content-between px-3 text-center a">
                                <div class="col-auto mr-sm-2 mx-1 card-block  py-0 text-center radio selected ">
                                    <div class="flex-row">
                                        <div class="col">
                                            <div class="pic"> <img class="irc_mut img-fluid" src="https://www.espacioteodora.cl/agendas/imagenes/WhatsApp-Image-2021-09-07-at-18.26.04.jpg" width="300" height="300"> </div>
                                            <p></p>
                                        </div>
                                        <input type="radio" name="radios" id="radio1" value='11' class="invisible-radio" checked>
                                        <label for="radio1">
                                            Manicure
                                ...
                                <div class="col-auto mr-sm-2 mx-1 card-block  py-0 text-center radio selected ">
                                    <div class="flex-row">
                                        <div class="col">
                                            <div class="pic"> <img class="irc_mut img-fluid" src="https://www.espacioteodora.cl/agendas/imagenes/08122020-_MG_7936-scaled.jpg" width="300" height="300"> </div>
                                            <p></p>
                                ...
                                <div class="col-auto mr-sm-2 mx-1 card-block  py-0 text-center radio selected ">
                                    <div class="flex-row">
                                        <div class="col">
                                            <div class="pic"> <img class="irc_mut img-fluid" src="https://www.espacioteodora.cl/agendas/imagenes/08122020-_MG_7742-scaled.jpg" width="300" height="300"> </div>
                                            <p></p>
                                ...
                                <div class="col-auto ml-sm-2 mx-1 card-block  py-0 text-center radio  ">
                                    <div class="flex-row">
                                        <div class="col">
                                            <div class="pic"> <img class="irc_mut img-fluid" src="https://www.espacioteodora.cl/agendas/imagenes/08122020-_MG_7862-scaled.jpg" width="300" height="300"> </div>
                                            <p></p>
                                            <input type="radio" name="radios" id="radio4" value='15' class="invisible-radio">
                                            <label for="radio4">
                                                Masajes
                                                <div class="styled-radio blue" data-text="Logo 3"></div>
                                            </label>
                                ...
                                <div class="col-auto ml-sm-2 mx-1 card-block  py-0 text-center radio  ">
                                    <div class="flex-row">
                                        <div class="col">
                                            <div class="pic"> <img class="irc_mut img-fluid" src="https://www.espacioteodora.cl/agendas/imagenes/beneficios-depilacion-cera.jpg" width="300" height="300"> </div>
                                            <p></p>
                                            <input type="radio" name="radios" id="radio4" value='16' class="invisible-radio">
                                            <label for="radio4">
                                                Depilacion
                                                <div class="styled-radio blue" data-text="Logo 3"></div>
                                            </label>
