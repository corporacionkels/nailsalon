...
<section class="booking_section">
    <div class="container">
        ...
        <form method="post" id="appointment_form" action="proses_complementarios.php">
            ...
            <div class="select_services_div tab_reservation" id="services_tab">
                ...
                <div class="items_tab">
                                    ...
                                    <div class="select_item_bttn">
                                        <div class="btn-group-toggle" data-toggle="buttons">
                                            <label class="service_label item_label btn btn-secondary">
                                                <input type="checkbox" name="selected_services[]" value="<?php echo $row['service_id'] ?>" autocomplete="off">Confirmar
                                            </label>
                                        </div>
                                    </div>
                                <?php
                    ...
                    ?>
                        <div class="panel panel-default">
                            <div class="panel-body"><b style="color:#0033FF" ;><?php echo $category_name; ?> Diseños Permanente y Semipermanente</b>
                                <div class="items_tab">
                                    <?php
                                    $stmt = $con->prepare("SELECT * from services WHERE category_id = '13'");
                                    //$stmt = $con->prepare("Select * from services where category_id = '11' order by category_id");
                                    $stmt->execute();
                                    $rows = $stmt->fetchAll();
                        ...
                        ?>
                            <div class="select_item_bttn">
                                <label class="item_label btn btn-secondary active">
                                    <input type="radio" class="radio_employee_select" name="selected_employee" value="<?php echo $row['employee_id'] ?>">Confirmar
                                </label>
                            </div>
                        <?php
                            echo "</div>";
            ...
            <div class="client_details_div tab_reservation" id="client_tab">
                ...
                <?php
                $stmt = $con->prepare("SELECT * from clients WHERE client_id ='$el_cliente'");
                $stmt->execute();
                $rows = $stmt->fetchAll();
                ...
                ?>
                    <div>
                        <div class="form-group colum-row row">
                            <div class="col-sm-6">
                                <input type="text" name="client_first_name" id="client_first_name" value = <?php echo $row['first_name'] ?> class="form-control" placeholder="First Name">
                                <span class="invalid-feedback">Este Dato es Requerido</span>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" name="client_last_name" id="client_last_name" value = <?php echo $row['last_name'] ?> class="form-control" placeholder="Last Name">
                                <span class="invalid-feedback">Este Dato es Requerido</span>
                            </div>
                            <div class="col-sm-6">
                                <input type="email" name="client_email" id="client_email" value = <?php echo $row['client_email'] ?> class="form-control" placeholder="E-mail">
                                <span class="invalid-feedback">Correo Invalido</span>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" name="client_phone_number" id="client_phone_number" value = <?php echo $row['phone_number'] ?> class="form-control" placeholder="Phone number">
                                <span class="invalid-feedback">Numero Telefono Invalido</span>
                            </div>
                            <div class="col-sm-6" style="display:none;">
                                <input type="text" name="servicio_complementario" value="<?php echo $la_cita ?>" class="form-control" placeholder="Phone number">
            ...
            <div style="overflow:auto;padding: 30px 0px;">
                ...
                <a href="confirm_page.php?id=<?php echo $la_cita;?>" class="next_prev_buttons" role="button" style="background-color: #bbbbbb;" aria-pressed="true">No deseo Servicios Complementarios</a>
