		...
		<?php
            ...
            if(isset($_POST['submit_book_appointment_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try
                {
					...
					{
						$stmtgetCurrentClientID = $con->prepare("SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'nailsalon' AND TABLE_NAME = 'clients'");
                    ...
                    $stmtgetCurrentAppointmentID = $con->prepare("SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'nailsalon' AND TABLE_NAME = 'appointments'");
		...
		<form method="post" id="appointment_form" action="appointment.php">
			...
			<div class="select_services_div tab_reservation" id="services_tab">
				...
				<div class="panel panel-default">
					<div class="panel-body"><b style="color:#0033FF";>Manicure</b>
					<div class="items_tab">
        			<?php
				...
				<div class="panel panel-primary">
					<div class="panel-body"><b style="color:#FF0033";>Pedicure</b>
					<div class="items_tab1">
        			<?php
        				$stmt = $con->prepare("Select * from services where category_id = '12' order by category_id");
                    	$stmt->execute();
                    	$rows = $stmt->fetchAll();
				...
				<div class="panel panel-default">
					<div class="panel-body"><b style="color:#0033FF";>Diseños</b>
					<div class="items_tab">
        			<?php
        				$stmt = $con->prepare("Select * from services where category_id = '13' order by category_id");
                    	$stmt->execute();
                    	$rows = $stmt->fetchAll();
				...
				<div class="panel panel-primary">
					<div class="panel-body"><b style="color:#FF0033";>Faciales</b>
					<div class="items_tab1">
        			<?php
        				$stmt = $con->prepare("Select * from services where category_id = '14' order by category_id");
                    	$stmt->execute();
                    	$rows = $stmt->fetchAll();
				...
				<div class="panel panel-default">
					<div class="panel-body"><b style="color:#0033FF";>Corporales</b>
					<div class="items_tab">
        			<?php
        				$stmt = $con->prepare("Select * from services where category_id = '15' order by category_id");
                    	$stmt->execute();
                    	$rows = $stmt->fetchAll();
